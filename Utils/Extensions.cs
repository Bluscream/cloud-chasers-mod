...
Rotation: {player.transform.rotation}";
        ...
        public static string str(this CarTornado truck) => $@"Name: {truck.name}
playersNameLabelText: {truck.playersNameLabelText}
owner.name: {truck.photonView.owner.name}
