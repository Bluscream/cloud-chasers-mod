...
namespace CloudChasers {
    ...
    static class customWelcomeText {
        ...
        static void Postfix() {
            ...
            info.text = "<color=#ffff00>Storm Chasers Mod Menu</color> - <color=#7d7d7d>version " + typeof(Mod).Assembly.GetName().Version + "</color>\n\nThank you for using my mod! If you have any issues, please contact me on Discord @ <color=#850aff>blu#3821</color>";
            if (Mod.isOnline()) {
